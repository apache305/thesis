...
%TODO Cath I think that the definition of the problem in chapter 5 should come here
%moved.

\subsection{Problem Definition: mining topics and communities}
%TODO Cath I think that this subsectin shld disappear. The formalisation should go in the introduction of chapter 4
...
%TODO Cath: what do you mean in the following sentence: You used an existing Python implementation of the LDA algorithm (and possibly made some modifications/extensions) (in this case you must cite/refer to it) or you developed your own implementation of LDA in Python?
%NOTE Zide I implement python version of lda.
...
%TODO Cath: put the following sentence as a third item in the enumeration at the end of the chapter and indicat where it is described in your thesis
%NOTE Zide, move to the end
...
\begin{enumerate}
 \item First, we developed a more simple method to detect topics and overlapping communities to solve the efficiency problem: the TTD method is presented in Chapter \ref{chap:ttd}.
  ...
  %NOTE Zide: integerated in item 2.
