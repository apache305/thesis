...
%TODO Cath use a presentation like in the previous chapters for algorithms
...
%TODO Cath : I added this her. TO be checked
We proposed a method called "Most+Top" which consists in creating the list of  the most recommended labels by all the above algorithms and then creating a label from this list by using the \"Top tags\" algorithm. 
...
The only difference for survey A and B is the linking (disambiguation) method. As mentioned in section \ref{sec:chp6secSolution}, we use both cosine similarity and Babelfy to link tags with DBpedia resources. 

%TODO Cath is the table correct? and the text above? I do not understand in which case you use the cosine similarity and in which case yu use Babelfy
...
%TODO Cath check the captions I added to all the following figures

%TODO Cath remove Agreement Alpha Score on your 3 subfigures
...
%TODO Cath correct in your 3 subfigures: percentage od users agreeing on ...
...
\caption{Number of topics as a function of the proportion of the top X voted labels}
\label{fig:chp6top} 
\end{figure}
...
%TODO Cath remove "different algorithms" in your 3 subfigures
