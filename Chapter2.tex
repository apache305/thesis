...
%corrected
% one direct is to develop evaluation methods to compare which the 'goodness'/'interpretable' of a topic.
...
%corrected, PLSA included, the forth line.
...
%correct it.
% this model can compute the probability of whether a user will answer a question.
